  ...
  return (
    <aside className="w-64 bg-[#0e2413] text-stone-100 min-h-screen flex flex-col justify-between p-4 border-r border-[#1a3d24]/40 z-30 shrink-0">
      <div className="space-y-6">
        {/* Brand Logo Header */}
        <div className="flex items-center gap-2 px-2 py-4 border-b border-emerald-950/60">
      ...
      <div className="border-t border-emerald-950/80 pt-4 space-y-3">
        ...
        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-stone-400 hover:bg-red-950/20 hover:text-red-400 text-xs sm:text-sm font-bold tracking-wide transition-colors cursor-pointer">
          <LogOut size={16} />
          <span>Sign Out</span>
        </button>
      </div>
